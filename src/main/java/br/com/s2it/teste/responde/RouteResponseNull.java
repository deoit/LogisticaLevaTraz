...
/**
 * The Class RouteResponseNull.
 */
public class RouteResponseNull extends RouteResponse implements Nullable {
	...
	/* (non-Javadoc)
	 * @see br.com.s2it.teste.responde.RouteResponse#ehNulo()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see br.com.s2it.teste.responde.RouteResponse#descricaoFalha()
	 */
	@Override
